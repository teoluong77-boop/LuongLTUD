package vn.edu.gdu.lab4.entity;
...
public class Product {
    ...
    @Column(name = "product_name", nullable = false, length = 150) // (5) Ánh xạ đến cột "product_name"
    private String name;

    @Column(name = "price", nullable = false, precision = 10, scale = 2) // (6) Kiểu tiền tệ dùng BigDecimal
    private BigDecimal price;

    @Column(name = "sku", unique = true, nullable = false, length = 50) // (7) Mã sản phẩm - duy nhất
    private String sku;
